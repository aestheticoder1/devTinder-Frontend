    ...
    return (
        <div className="text-center my-10">
            ...
            {connections.map((connection) => {
                ...
                return (
                    <div key={connection._id} className="flex justify-between items-center m-4 p-4 bg-base-300 rounded-lg w-1/2 mx-auto">
                        <div className="flex">
                            <div className="mx-4">
                        ...
                        <div>
                            <Link to={"/chat/" + connection._id}><button className="btn btn-outline btn-primary mx-2">Message</button></Link>
                        </div>
                    </div>
                )
            })}
