        ...
        <div className="card-body">
          ...
          <div>
            ...
            <label className="form-control w-full max-w-xs my-2">
              ...
              <input type="password" value={password} placeholder="Enter your password" className="input input-bordered w-full max-w-xs"
          ...
          <p className=" cursor-pointer m-auto py-2 text-blue-700" onClick={()=>setIsLoginForm((value) => !value)}>
            {isLoginForm ?
